            ...
            <aside className=' w-[18%] flex flex-col gap-5'>
                ...
                <div className='flex flex-col gap-[48px]'>
                    <div className='group relative items-center bg-blackSecondary p-4 rounded-lg'>
                        <div className='absolute w-[6px] h-[40px] rounded-full group-hover:bg-[#B4FFFF] transition duration-300 bg-primary -left-[2px] top-[15px]'></div>
                        <div className='absolute w-[6px] h-[40px] rounded-full group-hover:blur-md bg-[#B4FFFF] transition duration-300 -left-[2px] top-[15px]'></div>
            ...
            <section className='w-[85%] flex flex-col gap-4'>
                ...
                <form action="" className='p-5 mx-auto flex flex-col gap-4 bg-blackSecondary rounded-lg w-[85%]'>
                    ...
                    <div>
                        ...
                        <input type="textarea" className='w-[100%] rounded-lg h-36 bg-transparent border border-lightW/30 px-3'/>
                    </div>
                    <div>
                        <label htmlFor="">Imagem</label>
                        <input type="textarea" className='w-[100%] rounded-lg h-44 bg-transparent border border-lightW/30 px-3'/>
                    </div>
                </form>
            </section>
        </div>
