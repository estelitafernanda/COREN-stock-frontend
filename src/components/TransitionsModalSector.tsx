...
export default function TransitionsModalSector() {
        ...
        <Fade in={open}>
          <Box sx={style} className='flex flex-col px-16 py-12 font-[family-name:var(--font-geist-sans)]'>
            ...
            <div className='mt-8'>
              <div className='flex gap-5'>
                ...
                <div className='flex items-center'>
                  <h2 className='text-2xl font-bold'>DTIC</h2>
                </div>
              </div>
            </div>
            <div className='flex flex-col gap-10 w-full mt-10 space-between'>
                  <div className='flex flex-col gap-4 w-[100%]'>
                    <div className='flex flex-col gap-1'>
                      ...
                      <div className='bg-blackThirdy w-full h-16 rounded-lg px-3 flex items-center'>
                        <p className='text-sm font-semibold'>Natal - RN / sede</p>
                      </div>
                    </div>
                    <div className='flex flex-col gap-1'>
                        ...
                        <div className='flex flex-col w-full gap-3'>
                          <div className='flex gap-3 w-full justify-between items-center'>
                            <div className='flex gap-3 items-center'>
                              ...
                              <h2 className='text-sm font-bold'>Iran Vital</h2>
                            </div>
                          </div>
                  ...
                  <div className='w-[100%]'>
                    <h2 className='text-lg font-bold mb-1'>Funcionários <span className='text-lightW/50'>(<span className='text-primary'>4</span>)</span></h2>
                    <div className='flex flex-col gap-2'>
                        <div className='bg-blackThirdy w-full gap-4 rounded-lg px-3 flex flex-col p-3'>
                          <p className='text-sm font-semibold'>Iran Vital<span> - </span><span className='text-primary'>Admin</span></p>
                        </div>
                        <div className='bg-blackThirdy w-full gap-4 rounded-lg px-3 flex flex-col p-3'>
                          <p className='text-sm font-semibold'>Anna Luyza<span> - </span><span className='text-primary'>User</span></p>
                        </div>
                        <div className='bg-blackThirdy w-full gap-4 rounded-lg px-3 flex flex-col p-3'>
                          <p className='text-sm font-semibold'>Estelita Fernanda<span> - </span><span className='text-primary'>User</span></p>
                        </div>
                        <div className='bg-blackThirdy w-full gap-4 rounded-lg px-3 flex flex-col p-3'>
                          <p className='text-sm font-semibold'>Augusto Alexandre<span> - </span><span className='text-primary'>User</span></p>
                        </div>
                    </div>
